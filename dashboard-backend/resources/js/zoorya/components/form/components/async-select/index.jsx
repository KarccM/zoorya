...
export default function AsyncSelect({
    ...
    const fetchDataOptions = { ...defalutQueryParams }
    if (asyncSearch && searchQuarry) fetchDataOptions.search = searchQuarry;
            ...
            render={({ field: { onChange, value } }) => {
                return (
                    <Autocomplete
                        ...
                        onChange={(event, values, reason, ...rest) => {
                            handleChange
                                ? handleChange(event, values, reason, rest)
                                : onChange(values);
                        }}
